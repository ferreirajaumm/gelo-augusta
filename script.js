...
const languageData = {
  pt: {
    ...
    description: 'Gelo Augusta: marisqueira e restaurante de cozinha portuguesa na Rua Augusta, Baixa de Lisboa. Reserve a sua mesa por WhatsApp.',
    ...
    faqTitle: 'Antes de chegar ao Gelo Augusta.', faqText: 'Informação direta para organizar a sua visita à nossa marisqueira na Baixa de Lisboa.', faq: [['Onde fica o Gelo Augusta?', 'O Gelo Augusta fica na Rua Augusta 182, 1100-051 Lisboa, na Baixa de Lisboa.'], ['Como posso reservar uma mesa?', 'Use o formulário de reservas no site. Depois de preencher nome, contacto, data, hora e número de pessoas, o pedido abre diretamente no WhatsApp do Gelo Augusta para confirmação.'], ['Qual é o contacto para reservas?', 'Para reservas e informações, contacte o Gelo Augusta pelo número +351 967 573 815.'], ['Que tipo de cozinha encontro no Gelo Augusta?', 'A casa é dedicada ao marisco, peixe fresco e cozinha portuguesa, no centro histórico de Lisboa.']], locationTitle: 'Gelo Augusta, na Baixa de Lisboa.', locationText: 'Rua Augusta 182, 1100-051 Lisboa, Portugal. Depois de reservar, use o mapa apenas para traçar a sua rota.', contactCta: 'Fazer reserva', route: 'Ver rota no mapa', footerTitles: ['Informações', 'Localização'], footerInfo: 'Gelo Augusta<br>Rua Augusta 182<br>1100-051 Lisboa, Portugal', footerTagline: 'Marisqueira e cozinha portuguesa na Rua Augusta, em Lisboa.', footerLocation: 'Baixa de Lisboa<br>Rua Augusta, 182', footerLinks: ['Abrir localização', 'Avaliações públicas', 'Como chegar'],
  ...
  en: {
    ...
    faqTitle: 'Before you arrive at Gelo Augusta.', faqText: 'Straightforward information to help you plan your visit to our seafood restaurant in downtown Lisbon.', faq: [['Where is Gelo Augusta?', 'Gelo Augusta is at Rua Augusta 182, 1100-051 Lisbon, in downtown Lisbon.'], ['How can I book a table?', 'Use the booking form on the website. After you add your name, contact details, date, time and number of guests, the request opens directly in Gelo Augusta’s WhatsApp for confirmation.'], ['What is the number for bookings?', 'For bookings and information, contact Gelo Augusta on +351 967 573 815.'], ['What kind of food does Gelo Augusta serve?', 'The restaurant is dedicated to seafood, fresh fish and Portuguese cuisine in Lisbon’s historic centre.']], locationTitle: 'Gelo Augusta, in downtown Lisbon.', locationText: 'Rua Augusta 182, 1100-051 Lisbon, Portugal. Once you have booked, use the map only to plan your route.', contactCta: 'Make a booking', route: 'Get directions', footerTitles: ['Information', 'Location'], footerInfo: 'Gelo Augusta<br>Rua Augusta 182<br>1100-051 Lisbon, Portugal', footerTagline: 'Seafood and Portuguese cuisine on Rua Augusta, Lisbon.', footerLocation: 'Downtown Lisbon<br>Rua Augusta, 182', footerLinks: ['Open location', 'Public reviews', 'How to get here'],
  ...
  es: {
    ...
    faqTitle: 'Antes de llegar a Gelo Augusta.', faqText: 'Información directa para organizar su visita a nuestra marisquería en el centro de Lisboa.', faq: [['¿Dónde está Gelo Augusta?', 'Gelo Augusta está en Rua Augusta 182, 1100-051 Lisboa, en el centro de Lisboa.'], ['¿Cómo puedo reservar una mesa?', 'Use el formulario de reservas del sitio. Después de indicar nombre, contacto, fecha, hora y número de personas, la solicitud se abre directamente en el WhatsApp de Gelo Augusta para confirmación.'], ['¿Cuál es el contacto para reservas?', 'Para reservas e información, contacte con Gelo Augusta en el +351 967 573 815.'], ['¿Qué tipo de cocina ofrece Gelo Augusta?', 'La casa está dedicada al marisco, pescado fresco y cocina portuguesa en el centro histórico de Lisboa.']], locationTitle: 'Gelo Augusta, en el centro de Lisboa.', locationText: 'Rua Augusta 182, 1100-051 Lisboa, Portugal. Después de reservar, use el mapa solo para planificar su ruta.', contactCta: 'Hacer una reserva', route: 'Ver ruta en el mapa', footerTitles: ['Información', 'Ubicación'], footerInfo: 'Gelo Augusta<br>Rua Augusta 182<br>1100-051 Lisboa, Portugal', footerTagline: 'Marisquería y cocina portuguesa en Rua Augusta, Lisboa.', footerLocation: 'Centro de Lisboa<br>Rua Augusta, 182', footerLinks: ['Abrir ubicación', 'Reseñas públicas', 'Cómo llegar'],
...
function applyLanguage(lang) {
  ...
  setText('#titulo-perguntas', copy.faqTitle); setText('.faq-intro > p:not(.eyebrow)', copy.faqText);
  document.querySelectorAll('.faq-list details').forEach((item, index) => {
    const entry = copy.faq?.[index];
    if (entry) {
      setText('summary', entry[0], item);
      if (index === 2) setHtml('p', entry[1].replace('+351 967 573 815', '<a href="tel:+351967573815">+351 967 573 815</a>'), item);
      else setText('p', entry[1], item);
    }
  });
